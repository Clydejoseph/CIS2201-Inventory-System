        ...
        <div className='sideNav'>
            ...
            <Tabs orientation={'vertical'} variant={'unstyled'}>
                <TabList>
                    ...
                    <Tab _selected={{ color: 'white', bg: 'blue.500' }} onClick={() =>{navigate('/admin-request')}}>Requests</Tab>
                    <Tab _selected={{ color: 'white', bg: 'blue.500' }} onClick={() =>{navigate('/admin-account')}}>Manage Users</Tab>
                    <Tab _selected={{ color: 'white', bg: 'blue.500' }} onClick={() =>{navigate('/admin-log')}}>Activity Logs</Tab>
