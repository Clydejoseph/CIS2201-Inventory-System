...
function CreateItem() {
  ...
  const HandleSubmit = (e) => {
    const data = item;
    axios
      .post("http://localhost:5000/asset-create", data)
...
function UpdateItem({ selected }) {
  ...
  // const options = ['Active', 'Defective', 'Dispose', 'Donate'];
  ...
  const HandleSubmit = (e) => {
    const data = item;
    axios
      .post("http://localhost:5000/asset-update", data)
      .then(function (response) {
        console.log(response);
      })
      .catch(function (error) {
          ...
          <ModalBody pb={6}>
            <form onSubmit={HandleSubmit}>
              ...
              <FormControl>
                ...
                {selectedOption && (
                  <p id="status-notif">new selected status: {selectedOption}</p>
                )}
                <hr />
              </FormControl>
              {showInput && (
